	...
	return (
		...
		>
			<EvervaultCard
				text={
					<a
						href="https://raiyan-portfolio.s3.us-east-1.amazonaws.com/Raiyan_Razi_Resume_updated_16th_may_2025.pdf"
						download
...
const SkeletonFour = () => {
	...
	return (
		...
		>
			...
			>
				<BlurImage
					src="https://raiyan-portfolio.s3.us-east-1.amazonaws.com/bytemonk.jpg"
					alt="avatar"
					height="100"
					width="100"
					className="rounded-full h-14 w-14"
				/>
				<p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
					Clear and practical tutorials that simplify complex System
					Designs
				</p>
			</motion.a>
