		...
		<div className="w-full md:px-10" ref={containerRef}>
			<div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
				...
				<p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-3xl italic">
					I began my software engineering journey in 2020 at Richpanel,
					driven by a deep curiosity to solve problems. Over the years,
					I&apos;ve built high-performance frontend systems, optimized
					browser memory at scale, and led impactful Web3 products at
					Intract. I&apos;m now diving into cloud computing and distributed
					systems to architect scalable, efficient software end-to-end.
				</p>
			</div>
